...
<html data-navigation-type="default" data-navbar-horizontal-shape="default" lang="en-US" dir="ltr">
  ...
  <body>
    <main class="main" id="top">
              ...
              <div class="tab-pane fade show active" id="pills-month" role="tabpanel" aria-labelledby="pills-month-tab">
                <div class="row">
                  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                    <div class="h-100">
                      <input class="pricing-plan-radio d-none" type="radio" name="pricingMonthly" id="standard" />
                  ...
                  {{-- <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <form action="{{ route('stripe.checkout', ['plan' => 'price_1PGPwn1qUdsvpMoz2gaVJjiW']) }}" method="GET">
                          @csrf
                          <div class="mb-3">
                            <label class="form-label">Name </label>
                            <input class="form-control" name="name" id="" type="text" placeholder="name@example.com" />
                          </div>
                          <div class="mb-3">
                            <label class="form-label">Email address </label>
                            <input class="form-control" name="email" id="" type="email" placeholder="Full Name" />
                          </div>
                          <div class="mb-3">
                            <label class="form-label">Password </label>
                            <input class="form-control" name="password" id="" type="password" placeholder="Password" />
                          </div>
                          <div class="mb-3">
                            <label class="form-label">Email address </label>
      ...
      <div class="row">
        <div class="col-12">
          <a href="{{ route('stripe.checkout', 'price_1PGPwn1qUdsvpMoz2gaVJjiW') }}" type="button" class="btn btn-success">Go to checkout</a>
        </div>
      </div>
      {{-- <script>
