            ...
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              <li class="nav-item">
                <div class="nav-item-wrapper">
                    <a class="nav-link {{ Request::is('opportunities') ? 'active' : '' }}
                    {{ Request::is('opportunity/'.request()->route('id')) ? 'active' : '' }} label-1" href="{{ route('home') }}" role="button" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon">
                                <span data-feather="bar-chart"></span>
                            </span>
                            <span class="nav-link-text-wrapper">
                                <span class="nav-link-text">Your Opportunities</span>
                            </span>
                        </div>
                  </a>
                </div>
